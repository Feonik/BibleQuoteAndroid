...
import com.BibleQuote.BibleQuoteAndroid.ui.ServiceActivity;
		...
		thread = new Thread(new Runnable() {
			public void run() {
				try {
					...
					if (toModuleID != null) {
						LogTxt.i(TAG, String.format("Check of Versification Map from " +
								"Current Module to moduleID=%1$s", toModuleID));
